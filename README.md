...
<body>
<svg id="mfft" xmlns="http://www.w3.org/2000/svg"></svg>
<script>
(function(){
const T={n:'MFF/',t:'root',c:[
{n:'analysis/',t:'d',c:[
  {n:'batch_run_final/',t:'d',c:[
    {n:'baseline_vs_case02_t1055_5_attack/',t:'d'},
    {n:'baseline_vs_case03_t1059_attack/',t:'d'},
    {n:'baseline_vs_case04_t1574_attack/',t:'d'},
    {n:'baseline_vs_case05_multi_attack/',t:'d'},
    {n:'comparison_report/',t:'d'},
    {n:'batch_summary.json',t:'f'}]},
  {n:'comparison/',t:'d',c:[
    {n:'case01_vs_case02/',t:'d'},
    {n:'case01_vs_case03/',t:'d'},
    {n:'case01_vs_case03_baseline_slow_compa\u2026/',t:'d'},
    {n:'case01_vs_case03_t1059 short/',t:'d'},
    {n:'case01_vs_case04/',t:'d'},
    {n:'case01_vs_case04_old/',t:'d'},
    {n:'case01_vs_case05/',t:'d'}]},
  {n:'single/',t:'d',c:[
    {n:'case02_T1055_5_attack/',t:'d'},
    {n:'case04/',t:'d'},
    {n:'case05/',t:'d'}]}]},
{n:'cases/',t:'d',c:[
  {n:'case01_baseline/',t:'d',c:[{n:'exports/',t:'d'}]},
  {n:'case02_t1055_5_attack/',t:'d',c:[{n:'exports/',t:'d'}]},
  {n:'case03_t1059_attack/',t:'d',c:[{n:'exports/',t:'d'}]},
  {n:'case04_t1574_attack/',t:'d',c:[{n:'exports/',t:'d'}]},
  {n:'case05_multi_attack/',t:'d',c:[{n:'exports/',t:'d'}]}]},
{n:'docs/',t:'d',c:[
  {n:'artefact_schema.md',t:'f'},
  {n:'Case 04 \u2014 Artefact Analysis.md',t:'f'},
  {n:'case01_baseline_artefact_analysis.md',t:'f'},
  {n:'case03_t1059_artefact_analysis.md',t:'f'},
  {n:'case04_t1574_artefact_analysis.md',t:'f'},
  {n:'case04_t1574_artefact_schema.md',t:'f'},
  {n:'case05_commands_log.md',t:'f'},
  {n:'case05_dissertation_section.md',t:'f'},
  {n:'case05_evidence_index.md',t:'f'},
  {n:'case05_final_checklist.md',t:'f'},
  {n:'case05_memory_acquisition_and_integrity.md',t:'f'},
  {n:'case05_multi_attack_report_notes.md',t:'f'},
  {n:'case05_report_mapping.md',t:'f'},
  {n:'commands.md',t:'f'},
  {n:'final_project_checklist.md',t:'f'},
  {n:'hash_values.txt',t:'f'},
  {n:'MFF_COMMANDS.md',t:'f'}]},
{n:'lab-notes/',t:'d',c:[
  {n:'docs/',t:'d',c:[
    {n:'acquisition_log.md',t:'f'},
    {n:'case01_vs_case02_comparison.md',t:'f'},
    {n:'case02_t1055_5_attack_report.md',t:'f'},
    {n:'chain_of_custody.md',t:'f'},
    {n:'hash_values.txt',t:'f'},
    {n:'t1059_attack_report.md',t:'f'},
    {n:'vm_config.md',t:'f'}]},
  {n:'MFF_COMMANDS2.md',t:'f'},
  {n:'README.md',t:'f'},
  {n:'TEST 1Document.txt',t:'f'}]},
{n:'screenshots/',t:'d',c:[
  {n:'week1/',t:'d'},{n:'week2/',t:'d'},{n:'week3/',t:'d'},
  {n:'week4/',t:'d'},{n:'week5/',t:'d'}]},
{n:'src/',t:'d',c:[
  {n:'bak files/',t:'d'},
  {n:'modules/',t:'d',c:[
    {n:'automation.py',t:'f'},
    {n:'case_comparison.py',t:'f'},
    {n:'dll_analysis.py',t:'f'},
    {n:'export_alert.py',t:'f'},
    {n:'mff_dashboard.py',t:'f'},
    {n:'mitre_tagger.py',t:'f'},
    {n:'network_ioc.py',t:'f'},
    {n:'process_tree.py',t:'f'},
    {n:'report_generator.py',t:'f'},
    {n:'report_generator.py.bak',t:'f'},
    {n:'Unique_compare.py',t:'f'}]},
  {n:'comparison_engine_v2.py',t:'f',star:1}]},
{n:'.gitignore',t:'f'},
{n:'README.md',t:'f'}]};

const RH=16,IND=20,PL=28,PT=72,W=700;
const BLACK='#111',GRAY='#666',LGRAY='#bbb',DGRAY='#444';
const NS='http://www.w3.org/2000/svg';
const rows=[];
function flat(node,d){node.depth=d;node.y=PT+rows.length*RH;rows.push(node);if(node.c)for(const c of node.c)flat(c,d+1);}
flat(T,0);
const H=PT+rows.length*RH+46;
const svg=document.getElementById('mfft');
...
/* header box */
svg.appendChild(mk('rect',{x:PL,y:6,width:W-PL*2,height:28,rx:3,
  fill:'none',stroke:BLACK,'stroke-width':'0.75'}));
svg.appendChild(mk('text',{x:W/2,y:24,
  'font-size':'13','font-weight':'600','font-family':'Courier New, monospace',
  fill:BLACK,'text-anchor':'middle','dominant-baseline':'central'},
  'MFF \u2014 Memory Forensics Framework'));
svg.appendChild(mk('line',{x1:PL,y1:42,x2:W-PL,y2:42,stroke:LGRAY,'stroke-width':'0.5'}));
svg.appendChild(mk('text',{x:PL,y:57,
  'font-size':'11','font-family':'Courier New, monospace',fill:GRAY},
  '\u25cf directory  \u25cb file  \u2605 main engine'));

/* section dashes before each depth-1 node */
for(const n of rows){
  if(n.depth===1){
    svg.appendChild(mk('line',{
      x1:PL+14,y1:n.y-8,x2:W-PL,y2:n.y-8,
      stroke:LGRAY,'stroke-width':'0.5','stroke-dasharray':'2 5'}));
  }
}

/* connector lines */
for(const n of rows){
  if(!n.c||!n.c.length)continue;
  const nx=PL+n.depth*IND+6,last=n.c[n.c.length-1];
  svg.appendChild(mk('line',{x1:nx,y1:n.y+(n.t==='root'?5:3),x2:nx,y2:last.y,
    stroke:LGRAY,'stroke-width':'0.5'}));
  for(const ch of n.c){
    const cx=PL+ch.depth*IND+6;
    svg.appendChild(mk('line',{x1:nx,y1:ch.y,x2:cx-4,y2:ch.y,
      stroke:LGRAY,'stroke-width':'0.5'}));
  }
}
...
/* nodes + labels */
for(const n of rows){
  const nx=PL+n.depth*IND+6,isRoot=n.t==='root',isDir=n.t==='d'||isRoot;
  if(isRoot){
    svg.appendChild(mk('rect',{x:nx-5,y:n.y-5,width:10,height:10,rx:1,fill:BLACK}));
  } else if(isDir){
    svg.appendChild(mk('circle',{cx:nx,cy:n.y,r:3,fill:BLACK}));
  } else {
    svg.appendChild(mk('circle',{cx:nx,cy:n.y,r:2.5,fill:'none',stroke:DGRAY,'stroke-width':'0.7'}));
  }
  const tx=nx+(isRoot?11:9),lbl=(n.star?'\u2605 ':'')+n.n;
  const fw=(isRoot||(isDir&&n.depth===1))?'600':'400';
  const fc=isDir?BLACK:GRAY;
  svg.appendChild(mk('text',{x:tx,y:n.y+4,
    'font-size':'11','font-family':'Courier New, monospace',
    'font-weight':fw,fill:fc},lbl));
  if(n.star){
    svg.appendChild(mk('line',{x1:tx,y1:n.y+7,x2:tx+lbl.length*6.4,y2:n.y+7,
      stroke:BLACK,'stroke-width':'0.5','stroke-dasharray':'2 2'}));
  }
}

/* footer */
svg.appendChild(mk('line',{x1:PL,y1:H-24,x2:W-PL,y2:H-24,stroke:LGRAY,'stroke-width':'0.5'}));
svg.appendChild(mk('text',{x:PL,y:H-10,
  'font-size':'11','font-family':'Courier New, monospace',fill:GRAY},
  rows.length+' nodes \u00b7 '+rows.filter(r=>r.t==='f').length+' files \u00b7 6 sections'));
svg.appendChild(mk('text',{x:W-PL,y:H-10,
  'font-size':'11','font-family':'Courier New, monospace',fill:LGRAY,'text-anchor':'end'},
  'AntonIvanovMIA / data-engene-operation-secure'));
})();
</script>
</body>
</html>
Uploading mff_lab_structure.html…]()
